...
namespace aor
{
	...
	SimpleRenderSystem::SimpleRenderSystem(AoraDevice& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout) : aoraDevice{device}
	{
